...
namespace PsdUIExporter {
    ...
    public class ExpConfigVO {
        public string basePath = "Assets/_Restart/Things/UI/Textures/Base";
        ...
        public ExpConfigVO() {
            string config = AssetDatabase.LoadAssetAtPath<TextAsset>("Assets/Editor/_Restart/PsdUIExporter/psd_config.json").text;
